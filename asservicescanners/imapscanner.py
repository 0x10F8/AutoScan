...
from asservicescanners.serviceutils import IMAP_PORT, IMAP_SCRIPT, launch_script_without_terminal, format_script_args
...
class IMAPScanner(AbstractBannerScrapeScanner):
    ...
    def scan(self):
        ...
        launch_script_without_terminal(IMAP_SCRIPT, format_script_args(
